...
public class HelpRequestController {
   ...
   * @param requestTime the request time of the help request
   * @param explanation an example explanation of the help request
   * @param solved whether the help request has been solved or not
