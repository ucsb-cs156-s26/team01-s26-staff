...
public class ArticlesControllerTests extends ControllerTestCase {
  ...
  public void an_admin_user_can_post_a_new_article() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/articles/post?title=article1&url=https://www.example.com/article1&explanation=This is the first article&email=user@example.com&dateAdded=2022-01-03T00:00:00Z")
                    .with(csrf()))
  ...
  public void admin_can_edit_an_existing_article() throws Exception {
    ...
    when(articlesRepository.save(eq(articlesEdited))).thenReturn(articlesEdited);
